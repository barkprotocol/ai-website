...
Common knowledge:
- { token: BARK, description: The native token of BARK Protocol, x: @bark_protocol, website: https://barkprotocol.com/, address: 2NTvEssJ2i998V2cMGT4Fy3JhyFnAzHFonDo9dbAkVrg }
...
const commonKnowledge = {
  CommonKnowledge: [
    ...
    { user: "BARK Protocol", description: "BARK Protocol", twitter: "@bark_protocol", wallet: "BARKkeAwhTuFzcLHX4DjotRsmjXQ1MshGrZbn1CUQqMo" },
  ],
}
